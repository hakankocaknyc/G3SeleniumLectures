...
public class Sel_35_ExplicitlyWait_3 {
	...
	public static void main(String[] args) {
		...
		getElement(driver, email, 0).sendKeys("newjersey@sample.com");
		getElement(driver, password, 0).sendKeys("test12345");
		getElement(driver, loginBtn, 0).click();
